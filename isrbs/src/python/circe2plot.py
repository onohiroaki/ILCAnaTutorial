...
if __name__ == "__main__":
    ...
    parser.add_argument("-n",help="Number of events to print out",dest="nevents", default="1000")
    ...
    parser.add_argument("-f",help="Output root file name. Default=isrplot.root.", dest="rootfile", default="circe2plot.root")
...
#   ROOT initialize
    ...
    nt = ROOT.TNtuple("nt", "circe2", "eplus:eminus:roots")
    ebnom = roots/2.0
...
#        print "Evt# %d : (Ee-,Ee+)=(%g,%g) " % ( ievt, bsene[0], bsene[1] )
        eminus = bsene[0]*ebnom
        eplus = bsene[1]*ebnom
        rs = eminus + eplus
        nt.Fill(eminus, eplus, rs )

    tfile.Write()
    tfile.Close()
    print "circe2plot has completed."

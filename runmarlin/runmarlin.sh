...
ildconfig=/cvmfs/ilc.desy.de/sw/ILDConfig/v02-01-02/StandardConfig/production
...
time Marlin /cvmfs/ilc.desy.de/sw/ILDConfig/v02-01-02/StandardConfig/production/MarlinStdReco.xml \
  --global.LCIOInputFiles=../runddsim/bbudsc_3evt.m${simdetector}.slcio \
  --constant.OutputBaseName=bbudsc_3evt.m${recdetector} \
  --constant.DetectorModel=${recdetector} \
  --constant.lcgeo_DIR=${lcgeo_DIR} \
  --constant.RunOverlay=false \

...
class B2bDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  private:
    ...
    G4LogicalVolume*   fSensor1LV;    // pointer to the logical Chamber
    G4LogicalVolume*   fSensor2LV;    // pointer to the logical Chamber
    G4LogicalVolume*   fSensor3LV;    // pointer to the logical Chamber

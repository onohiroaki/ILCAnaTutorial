...
G4VPhysicalVolume* B2bDetectorConstruction::DefineVolumes()
{
  ...
  G4LogicalVolume* sensor1LV
    = new G4LogicalVolume(sensor1S, air, "Sensor1",0,0,0);
  new G4PVPlacement(0,               // no rotation
                    positionTracker, // at (x,y,z)
                    sensor1LV,       // its logical volume
                    "Sensor1",       // its name
  ...
  G4LogicalVolume* sensor2LV
    = new G4LogicalVolume(sensor2S, air, "Sensor2",0,0,0);
  new G4PVPlacement(0,               // no rotation
                    positionTracker, // at (x,y,z)
                    sensor2LV,       // its logical volume
                    "Sensor2",       // its name
                    trackerLV,         // its mother  volume
                    false,           // no boolean operations
                    0,               // copy number
  ...
  G4LogicalVolume* sensor3LV
    = new G4LogicalVolume(sensor3S, air, "Sensor3",0,0,0);
  new G4PVPlacement(0,               // no rotation
                    positionTracker, // at (x,y,z)
                    sensor3LV,       // its logical volume
                    "Sensor3",       // its name
                    trackerLV,         // its mother  volume
                    false,           // no boolean operations
                    0,               // copy number
  ...
  sensor1LV ->SetVisAttributes(senVisAtt);
  sensor2LV ->SetVisAttributes(senVisAtt);
  sensor3LV ->SetVisAttributes(senVisAtt);

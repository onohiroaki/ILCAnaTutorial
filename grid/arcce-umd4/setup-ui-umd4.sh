...
#17/5/17 switched export -n for unset to remove bashisms  

base=/cvmfs/grid.cern.ch/umd-c7ui-latest
...
export LCG_GFAL_INFOSYS=kek2-bdii03.cc.kek.jp:2170,kek2-bdii04.cc.kek.jp:2170,bdii.grid.sinica.edu.tw:2170
